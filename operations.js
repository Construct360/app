...
function renderAccessGuide(){
  $('records').innerHTML=`<div class="permission-grid">${[
    ['Company Admin','Manage clients, jobs, staff, teams, bookings and vehicles. Carry out vehicle inspections and resolve defects. Invite, disable and permanently delete company user accounts. Import and export Clients & Jobs.'],
    ['Operations','Manage clients, jobs, staff profiles, teams, bookings and vehicles. Carry out vehicle inspections and resolve defects. Cannot administer login accounts, use the Admin import/export tool or enter Platform Administration.'],
    ['Supervisor','View jobs and instructions for their own scheduled assignments, plus crew names and working roles. View company vehicles and inspection history, and carry out vehicle inspections. No management edits or private staff notes.'],
    ['Operative','View their own scheduled assignments, job location and instructions. View company vehicles and inspection history, and carry out vehicle inspections. No client or staff directories or management edits.'],
